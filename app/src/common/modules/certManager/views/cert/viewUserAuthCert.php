...
<div class="tab-buttons" style="margin-bottom: 1em;">
    <?= Html::a(Yii::t('app', 'Back'), '/certManager/cert/userkeys', ['class' => 'btn btn-default']) ?>
<?php
...
$script = <<<JS
    $('body').on('click', '#save-cert-submit', function(e) {
        var benefs = $('input[name="beneficiarySelectedInput"]').val();
        if (benefs === '[]') {
