 ...
 * @todo Избавиться от зависимостей от SSLException вне модуля
 *       и от метода get(set)Error: наружу рейзить только yii\base\Exception
 *
...
class Module extends BaseModule
{
    ...
    {
        return Yii::$app->exchange->defaultTerminalId . '-' . $fingerprint;
    }
