 ...
 */
class CFTStatusReportCyberXmlContent extends CyberXmlContent  implements TypeCyberXmlContentInterface
{
    ...
    public function init()
    {
        ...
        if (is_null($this->_parent->_typeModel)) {
            $this->_typeModel = new CFTStatusReportType();
        } else {
            $this->_typeModel = $this->_parent->_typeModel;
        }
    }

    public function loadFromTypeModel(CFTStatusReportType $model)
    {
