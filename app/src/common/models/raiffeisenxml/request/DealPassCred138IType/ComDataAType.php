...
class ComDataAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred138IType\ComDataAType\CurrAType $curr
     */
    private $curr = null;
     ...
     *
     * @property \common\models\raiffeisenxml\request\CurrAmountType $sumTransfer
     */
     ...
     *
     * @property \common\models\raiffeisenxml\request\CurrAmountType $sumCurr
     */
     ...
     * Валюта цены кредитного договора
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred138IType\ComDataAType\CurrAType
     */
     ...
     * Валюта цены кредитного договора
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred138IType\ComDataAType\CurrAType $curr
     * @return static
     */
    public function setCurr(\common\models\raiffeisenxml\request\DealPassCred138IType\ComDataAType\CurrAType $curr)
    {
        $this->curr = $curr;
        return $this;
    }
     ...
     * Сумма, подлежащая зачислению на счета за рубежом
     *
     * @param \common\models\raiffeisenxml\request\CurrAmountType $sumTransfer
     * @return static
     */
    public function setSumTransfer(\common\models\raiffeisenxml\request\CurrAmountType $sumTransfer)
    {
     ...
     * Сумма, погашение которой предполагается за счет валютной выручки
     *
     * @param \common\models\raiffeisenxml\request\CurrAmountType $sumCurr
     * @return static
     */
    public function setSumCurr(\common\models\raiffeisenxml\request\CurrAmountType $sumCurr)
    {
