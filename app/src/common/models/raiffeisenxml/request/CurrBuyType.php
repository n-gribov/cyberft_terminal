...
class CurrBuyType
{
     ...
     * Сделка
     *
     * @property \common\models\raiffeisenxml\request\CurrBuyTransType $trans
     */
    private $trans = null;
     ...
     * Сделка
     *
     * @return \common\models\raiffeisenxml\request\CurrBuyTransType
     */
     ...
     * Сделка
     *
     * @param \common\models\raiffeisenxml\request\CurrBuyTransType $trans
     * @return static
     */
    public function setTrans(\common\models\raiffeisenxml\request\CurrBuyTransType $trans)
    {
        $this->trans = $trans;
        return $this;
    }
