...
namespace common\models\raiffeisenxml\request\PayDocCurType;
...
class VoSumInfoAType
{
    ...
    /**
     * @property \common\models\raiffeisenxml\request\PayDocCurType\VoSumInfoAType\VoSumAType[] $voSum
     */
    private $voSum = [
     ...
     */
    public function addToVoSum(\common\models\raiffeisenxml\request\PayDocCurType\VoSumInfoAType\VoSumAType $voSum)
    {
        $this->voSum[] = $voSum;
        return $this;
    }
