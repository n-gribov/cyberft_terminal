...
namespace common\models\raiffeisenxml\request\CertifRegenRequestType\DocsAType;
...
class DocAType
{
    ...
    /**
     * Идентификатор запроса на сертификат для идентификации запроса на переген. при загрузке сертификата из УЦ
     *
     ...
     * Отдельное вложение
     *
     * @property \common\models\raiffeisenxml\request\CertifRegenRequestType\DocsAType\DocAType\AttachmentAType $attachment
     */
     ...
     * Отдельное вложение
     *
     * @return \common\models\raiffeisenxml\request\CertifRegenRequestType\DocsAType\DocAType\AttachmentAType
     */
     ...
     * Отдельное вложение
     *
     * @param \common\models\raiffeisenxml\request\CertifRegenRequestType\DocsAType\DocAType\AttachmentAType $attachment
     * @return static
     */
    public function setAttachment(\common\models\raiffeisenxml\request\CertifRegenRequestType\DocsAType\DocAType\AttachmentAType $attachment)
    {
