...
/**
 * Class representing ConfDocCertificateDoc138IRaifType
 *
 *
 * XSD Type: ConfDocCertificateDoc138IRaif
 */
class ConfDocCertificateDoc138IRaifType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IRaifType\DocSumAType $docSum
     */
    private $docSum = null;
     ...
     *
     * @property \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IRaifType\ContrSumAType $contrSum
     */
     ...
     * Сумма в ед. валюты документа
     *
     * @return \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IRaifType\DocSumAType
     */
     ...
     * Сумма в ед. валюты документа
     *
     * @param \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IRaifType\DocSumAType $docSum
     * @return static
     */
    public function setDocSum(\common\models\raiffeisenxml\request\ConfDocCertificateDoc138IRaifType\DocSumAType $docSum)
    {
        $this->docSum = $docSum;
        return $this;
    }
     ...
     * Сумма в ед. валюты контракта
     *
     * @return \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IRaifType\ContrSumAType
     */
     ...
     * Сумма в ед. валюты контракта
     *
     * @param \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IRaifType\ContrSumAType $contrSum
     * @return static
     */
    public function setContrSum(\common\models\raiffeisenxml\request\ConfDocCertificateDoc138IRaifType\ContrSumAType $contrSum)
    {
     ...
     * Сумма, соответствующая признаку поставки 2 или 3
     *
     * @param float $delDirSum
     * @return static
     */
    public function setDelDirSum($delDirSum)
    {
     ...
     * Сумма, соответствующая признаку поставки 2 или 3, в единицах валюты контракта
     *
     * @param float $delDirSumContr
     * @return static
     */
    public function setDelDirSumContr($delDirSumContr)
    {
