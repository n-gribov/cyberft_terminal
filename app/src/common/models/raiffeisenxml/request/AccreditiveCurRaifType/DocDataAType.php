...
class DocDataAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\AccreditiveCurRaifType\DocDataAType\AuthPersAType $authPers
     */
     ...
     * Уполномоченный сотрудник организации клиента
     *
     * @return \common\models\raiffeisenxml\request\AccreditiveCurRaifType\DocDataAType\AuthPersAType
     */
     ...
     * Уполномоченный сотрудник организации клиента
     *
     * @param \common\models\raiffeisenxml\request\AccreditiveCurRaifType\DocDataAType\AuthPersAType $authPers
     * @return static
     */
    public function setAuthPers(\common\models\raiffeisenxml\request\AccreditiveCurRaifType\DocDataAType\AuthPersAType $authPers)
    {
