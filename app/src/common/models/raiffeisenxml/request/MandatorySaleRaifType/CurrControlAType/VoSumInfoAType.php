...
class VoSumInfoAType
{
    ...
    /**
     * @property \common\models\raiffeisenxml\request\MandatorySaleRaifType\CurrControlAType\VoSumInfoAType\VoSumAType[] $voSum
     */
    private $voSum = [
     ...
     */
    public function addToVoSum(\common\models\raiffeisenxml\request\MandatorySaleRaifType\CurrControlAType\VoSumInfoAType\VoSumAType $voSum)
    {
        $this->voSum[] = $voSum;
        return $this;
    }
