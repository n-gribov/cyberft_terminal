...
/**
 * Class representing DealPassCon138IRaifType
 *
 *
 * XSD Type: DealPassCon138IRaif
 */
class DealPassCon138IRaifType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCon138IRaifType\ResInfoAType $resInfo
     */
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCon138IRaifType\ComDataAType $comData
     */
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCon138IRaifType\RefInfoAType $refInfo
     */
     ...
     * 1. Сведения о резиденте
     *
     * @return \common\models\raiffeisenxml\request\DealPassCon138IRaifType\ResInfoAType
     */
     ...
     * 1. Сведения о резиденте
     *
     * @param \common\models\raiffeisenxml\request\DealPassCon138IRaifType\ResInfoAType $resInfo
     * @return static
     */
    public function setResInfo(\common\models\raiffeisenxml\request\DealPassCon138IRaifType\ResInfoAType $resInfo)
    {
     ...
     * 3. Общие сведения о контракте
     *
     * @return \common\models\raiffeisenxml\request\DealPassCon138IRaifType\ComDataAType
     */
     ...
     * 3. Общие сведения о контракте
     *
     * @param \common\models\raiffeisenxml\request\DealPassCon138IRaifType\ComDataAType $comData
     * @return static
     */
    public function setComData(\common\models\raiffeisenxml\request\DealPassCon138IRaifType\ComDataAType $comData)
    {
     ...
     * 7. Справочная информация
     *
     * @return \common\models\raiffeisenxml\request\DealPassCon138IRaifType\RefInfoAType
     */
     ...
     * 7. Справочная информация
     *
     * @param \common\models\raiffeisenxml\request\DealPassCon138IRaifType\RefInfoAType $refInfo
     * @return static
     */
    public function setRefInfo(\common\models\raiffeisenxml\request\DealPassCon138IRaifType\RefInfoAType $refInfo)
    {
