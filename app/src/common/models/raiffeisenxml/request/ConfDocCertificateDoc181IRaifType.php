...
/**
 * Class representing ConfDocCertificateDoc181IRaifType
 *
 *
 * XSD Type: ConfDocCertificateDoc181IRaif
 */
class ConfDocCertificateDoc181IRaifType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType\DocSumAType $docSum
     */
    private $docSum = null;
     ...
     *
     * @property \common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType\ContrSumAType $contrSum
     */
     ...
     * Сумма в ед. валюты документа
     *
     * @return \common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType\DocSumAType
     */
     ...
     * Сумма в ед. валюты документа
     *
     * @param \common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType\DocSumAType $docSum
     * @return static
     */
    public function setDocSum(\common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType\DocSumAType $docSum)
    {
        $this->docSum = $docSum;
        return $this;
    }
     ...
     * Сумма в ед. валюты контракта
     *
     * @return \common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType\ContrSumAType
     */
     ...
     * Сумма в ед. валюты контракта
     *
     * @param \common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType\ContrSumAType $contrSum
     * @return static
     */
    public function setContrSum(\common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType\ContrSumAType $contrSum)
    {
