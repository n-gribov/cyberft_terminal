 ...
 */
class CurrDealCertificate138IType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DocDataCC138IType $docData
     */
     ...
     * Общие реквизиты документа ВК ДБО
     *
     * @return \common\models\raiffeisenxml\request\DocDataCC138IType
     */
     ...
     * Общие реквизиты документа ВК ДБО
     *
     * @param \common\models\raiffeisenxml\request\DocDataCC138IType $docData
     * @return static
     */
    public function setDocData(\common\models\raiffeisenxml\request\DocDataCC138IType $docData)
    {
