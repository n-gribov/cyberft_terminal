...
/**
 * Class representing CurrConvRaifType
 *
 *
 * XSD Type: CurrConvRaif
 */
class CurrConvRaifType
{
    ...
    /**
     * Реквизиты списания и зачисления
     *
     * @property \common\models\raiffeisenxml\request\CurrConvTransRaifType $trans
     */
    private $trans = null;
     ...
     * Реквизиты списания и зачисления
     *
     * @return \common\models\raiffeisenxml\request\CurrConvTransRaifType
     */
     ...
     * Реквизиты списания и зачисления
     *
     * @param \common\models\raiffeisenxml\request\CurrConvTransRaifType $trans
     * @return static
     */
    public function setTrans(\common\models\raiffeisenxml\request\CurrConvTransRaifType $trans)
    {
        $this->trans = $trans;
        return $this;
    }
