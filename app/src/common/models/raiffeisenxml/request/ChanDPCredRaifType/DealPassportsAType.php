...
class DealPassportsAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\ChanDPCredRaifType\DealPassportsAType\DealPassAType[] $dealPass
     */
    private $dealPass = [
     ...
     */
    public function addToDealPass(\common\models\raiffeisenxml\request\ChanDPCredRaifType\DealPassportsAType\DealPassAType $dealPass)
    {
