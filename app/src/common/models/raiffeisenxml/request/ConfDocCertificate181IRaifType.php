...
/**
 * Class representing ConfDocCertificate181IRaifType
 *
 *
 * XSD Type: ConfDocCertificate181IRaif
 */
class ConfDocCertificate181IRaifType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DocDataConf181IRaifType $docData
     */
    private $docData = null;

    /**
     * @property \common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType[] $table
     */
    private $table = null;
     ...
     * Общие реквизиты документа
     *
     * @return \common\models\raiffeisenxml\request\DocDataConf181IRaifType
     */
     ...
     * Общие реквизиты документа
     *
     * @param \common\models\raiffeisenxml\request\DocDataConf181IRaifType $docData
     * @return static
     */
    public function setDocData(\common\models\raiffeisenxml\request\DocDataConf181IRaifType $docData)
    {
     ...
     */
    public function addToTable(\common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType $oper)
    {
        $this->table[] = $oper;
        return $this;
    }
     ...
     * Sets a new table
     *
     * @param \common\models\raiffeisenxml\request\ConfDocCertificateDoc181IRaifType[] $table
     * @return static
     */
