 ...
 */
class ConfDocCertificate138IType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DocDataConf138IType $docData
     */
    private $docData = null;

    /**
     * @property \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IType[] $table
     */
    private $table = null;
     ...
     * Общие реквизиты документа
     *
     * @return \common\models\raiffeisenxml\request\DocDataConf138IType
     */
     ...
     * Общие реквизиты документа
     *
     * @param \common\models\raiffeisenxml\request\DocDataConf138IType $docData
     * @return static
     */
    public function setDocData(\common\models\raiffeisenxml\request\DocDataConf138IType $docData)
    {
     ...
     *
     * @return static
     * @param \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IType $oper
     */
    public function addToTable(\common\models\raiffeisenxml\request\ConfDocCertificateDoc138IType $oper)
    {
        $this->table[] = $oper;
        return $this;
    }
     ...
     * Gets as table
     *
     * @return \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IType[]
     */
     ...
     * Sets a new table
     *
     * @param \common\models\raiffeisenxml\request\ConfDocCertificateDoc138IType[] $table
     * @return static
     */
