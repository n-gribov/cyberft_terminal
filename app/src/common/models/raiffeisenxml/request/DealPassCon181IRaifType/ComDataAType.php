...
class ComDataAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCon181IRaifType\ComDataAType\CurrAType $curr
     */
    private $curr = null;
     ...
     * Валюта цены контракта
     *
     * @return \common\models\raiffeisenxml\request\DealPassCon181IRaifType\ComDataAType\CurrAType
     */
     ...
     * Валюта цены контракта
     *
     * @param \common\models\raiffeisenxml\request\DealPassCon181IRaifType\ComDataAType\CurrAType $curr
     * @return static
     */
    public function setCurr(\common\models\raiffeisenxml\request\DealPassCon181IRaifType\ComDataAType\CurrAType $curr)
    {
        $this->curr = $curr;
        return $this;
    }
