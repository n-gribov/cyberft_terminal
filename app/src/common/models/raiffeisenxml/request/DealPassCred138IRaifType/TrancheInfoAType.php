...
class TrancheInfoAType
{
    ...
    /**
     * @property \common\models\raiffeisenxml\request\DealPassCred138IRaifType\TrancheInfoAType\OperAType[] $oper
     */
    private $oper = [
     ...
     */
    public function addToOper(\common\models\raiffeisenxml\request\DealPassCred138IRaifType\TrancheInfoAType\OperAType $oper)
    {
        $this->oper[] = $oper;
        return $this;
    }
