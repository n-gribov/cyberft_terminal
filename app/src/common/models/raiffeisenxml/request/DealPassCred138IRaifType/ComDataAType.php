...
class ComDataAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred138IRaifType\ComDataAType\CurrAType $curr
     */
    private $curr = null;
     ...
     * Валюта цены кредитного договора
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred138IRaifType\ComDataAType\CurrAType
     */
     ...
     * Валюта цены кредитного договора
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred138IRaifType\ComDataAType\CurrAType $curr
     * @return static
     */
    public function setCurr(\common\models\raiffeisenxml\request\DealPassCred138IRaifType\ComDataAType\CurrAType $curr)
    {
        $this->curr = $curr;
        return $this;
    }
