...
class PercentAType
{
     ...
     *  например, Л06
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred138IRaifType\SpecDataAType\PercentAType\LIBORAType $lIBOR
     */
    private $lIBOR = null;
     ...
     *  например, Л06
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred138IRaifType\SpecDataAType\PercentAType\LIBORAType
     */
     ...
     *  например, Л06
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred138IRaifType\SpecDataAType\PercentAType\LIBORAType $lIBOR
     * @return static
     */
    public function setLIBOR(\common\models\raiffeisenxml\request\DealPassCred138IRaifType\SpecDataAType\PercentAType\LIBORAType $lIBOR)
    {
        $this->lIBOR = $lIBOR;
        return $this;
    }
