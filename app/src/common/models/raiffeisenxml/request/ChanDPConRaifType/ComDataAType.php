...
class ComDataAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\ChanDPConRaifType\ComDataAType\CurrAType $curr
     */
    private $curr = null;
     ...
     * Валюта цены контракта
     *
     * @return \common\models\raiffeisenxml\request\ChanDPConRaifType\ComDataAType\CurrAType
     */
     ...
     * Валюта цены контракта
     *
     * @param \common\models\raiffeisenxml\request\ChanDPConRaifType\ComDataAType\CurrAType $curr
     * @return static
     */
    public function setCurr(\common\models\raiffeisenxml\request\ChanDPConRaifType\ComDataAType\CurrAType $curr)
    {
        $this->curr = $curr;
        return $this;
    }
