...
/**
 * Class representing CurrConvType
 *
 *
 * XSD Type: CurrConv
 */
class CurrConvType
{
     ...
     * Сделка
     *
     * @property \common\models\raiffeisenxml\request\CurrConvTransType $trans
     */
    private $trans = null;
     ...
     * Сделка
     *
     * @return \common\models\raiffeisenxml\request\CurrConvTransType
     */
     ...
     * Сделка
     *
     * @param \common\models\raiffeisenxml\request\CurrConvTransType $trans
     * @return static
     */
    public function setTrans(\common\models\raiffeisenxml\request\CurrConvTransType $trans)
    {
        $this->trans = $trans;
        return $this;
    }
