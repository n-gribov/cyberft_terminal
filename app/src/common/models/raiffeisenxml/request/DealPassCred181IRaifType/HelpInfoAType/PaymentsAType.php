...
class PaymentsAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred181IRaifType\HelpInfoAType\PaymentsAType\ReturnAType[] $return
     */
    private $return = [
     ...
     *
     * @return static
     * @param \common\models\raiffeisenxml\request\DealPassCred181IRaifType\HelpInfoAType\PaymentsAType\ReturnAType $return
     */
    public function addToReturn(\common\models\raiffeisenxml\request\DealPassCred181IRaifType\HelpInfoAType\PaymentsAType\ReturnAType $return)
    {
        $this->return[] = $return;
        return $this;
    }
     ...
     *  и процентных платежей
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred181IRaifType\HelpInfoAType\PaymentsAType\ReturnAType[]
     */
