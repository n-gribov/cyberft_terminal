...
/**
 * Class representing RefundAType
 */
class RefundAType
{
     ...
     * Получатель
     *
     * @property \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\PayeeAType $payee
     */
    private $payee = null;
     ...
     * Банк получателя
     *
     * @property \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\PayeeBankAType $payeeBank
     */
     ...
     * Банк посредник.
     *
     * @property \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\MediaBankAType $mediaBank
     */
     ...
     * Получатель
     *
     * @return \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\PayeeAType
     */
     ...
     * Получатель
     *
     * @param \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\PayeeAType $payee
     * @return static
     */
    public function setPayee(\common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\PayeeAType $payee)
    {
        $this->payee = $payee;
        return $this;
    }
     ...
     * Банк получателя
     *
     * @return \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\PayeeBankAType
     */
     ...
     * Банк получателя
     *
     * @param \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\PayeeBankAType $payeeBank
     * @return static
     */
    public function setPayeeBank(\common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\PayeeBankAType $payeeBank)
    {
     ...
     * Банк посредник.
     *
     * @return \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\MediaBankAType
     */
     ...
     * Банк посредник.
     *
     * @param \common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\MediaBankAType $mediaBank
     * @return static
     */
    public function setMediaBank(\common\models\raiffeisenxml\request\LetterOfDepositRaifType\RefundAType\MediaBankAType $mediaBank)
    {
