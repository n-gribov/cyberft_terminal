...
/**
 * Class representing DealPassCred181IRaifType
 *
 *
 * XSD Type: DealPassCred181IRaif
 */
class DealPassCred181IRaifType
{
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred181IRaifType\ResInfoAType $resInfo
     */
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred181IRaifType\ComDataAType $comData
     */
     ...
     *  договору
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred181IRaifType\TrancheInfoAType\OperAType[] $trancheInfo
     */
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred181IRaifType\RefInfoAType $refInfo
     */
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred181IRaifType\SpecDataAType $specData
     */
     ...
     *
     * @property \common\models\raiffeisenxml\request\DealPassCred181IRaifType\HelpInfoAType $helpInfo
     */
     ...
     * 1. Сведения о резиденте
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred181IRaifType\ResInfoAType
     */
     ...
     * 1. Сведения о резиденте
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred181IRaifType\ResInfoAType $resInfo
     * @return static
     */
    public function setResInfo(\common\models\raiffeisenxml\request\DealPassCred181IRaifType\ResInfoAType $resInfo)
    {
     ...
     * 3.1 Общие сведения о кредитном договоре
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred181IRaifType\ComDataAType
     */
     ...
     * 3.1 Общие сведения о кредитном договоре
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred181IRaifType\ComDataAType $comData
     * @return static
     */
    public function setComData(\common\models\raiffeisenxml\request\DealPassCred181IRaifType\ComDataAType $comData)
    {
     ...
     */
    public function addToTrancheInfo(\common\models\raiffeisenxml\request\DealPassCred181IRaifType\TrancheInfoAType\OperAType $oper)
    {
     ...
     *  договору
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred181IRaifType\TrancheInfoAType\OperAType[] $trancheInfo
     * @return static
     */
     ...
     * 7. Справочная информация
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred181IRaifType\RefInfoAType
     */
     ...
     * 7. Справочная информация
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred181IRaifType\RefInfoAType $refInfo
     * @return static
     */
    public function setRefInfo(\common\models\raiffeisenxml\request\DealPassCred181IRaifType\RefInfoAType $refInfo)
    {
     ...
     * 8. Специальные сведения о кредитном договоре
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred181IRaifType\SpecDataAType
     */
     ...
     * 8. Специальные сведения о кредитном договоре
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred181IRaifType\SpecDataAType $specData
     * @return static
     */
    public function setSpecData(\common\models\raiffeisenxml\request\DealPassCred181IRaifType\SpecDataAType $specData)
    {
     ...
     * 9 Справочная информация о кредитном договоре
     *
     * @return \common\models\raiffeisenxml\request\DealPassCred181IRaifType\HelpInfoAType
     */
     ...
     * 9 Справочная информация о кредитном договоре
     *
     * @param \common\models\raiffeisenxml\request\DealPassCred181IRaifType\HelpInfoAType $helpInfo
     * @return static
     */
    public function setHelpInfo(\common\models\raiffeisenxml\request\DealPassCred181IRaifType\HelpInfoAType $helpInfo)
    {
