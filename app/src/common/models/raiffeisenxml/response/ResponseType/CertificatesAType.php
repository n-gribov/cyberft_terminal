...
class CertificatesAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\response\ResponseType\CertificatesAType\CertificateAType[] $certificate
     */
    private $certificate = [
     ...
     */
    public function addToCertificate(\common\models\raiffeisenxml\response\ResponseType\CertificatesAType\CertificateAType $certificate)
    {
