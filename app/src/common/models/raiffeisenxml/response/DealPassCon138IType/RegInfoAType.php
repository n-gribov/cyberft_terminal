...
class RegInfoAType
{
    ...
    /**
     * @property \common\models\raiffeisenxml\response\DealPassCon138IType\RegInfoAType\RegAType[] $reg
     */
    private $reg = [
     ...
     */
    public function addToReg(\common\models\raiffeisenxml\response\DealPassCon138IType\RegInfoAType\RegAType $reg)
    {
        $this->reg[] = $reg;
        return $this;
    }
