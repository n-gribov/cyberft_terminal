...
class ContractInfoType
{
     ...
     *
     * @property \common\models\raiffeisenxml\response\ContractInfoType\BlockInfoAType $blockInfo
     */
     ...
     * Информация о приостановлении обслуживания в системе ДБО
     *
     * @return \common\models\raiffeisenxml\response\ContractInfoType\BlockInfoAType
     */
     ...
     * Информация о приостановлении обслуживания в системе ДБО
     *
     * @param \common\models\raiffeisenxml\response\ContractInfoType\BlockInfoAType $blockInfo
     * @return static
     */
    public function setBlockInfo(\common\models\raiffeisenxml\response\ContractInfoType\BlockInfoAType $blockInfo)
    {
