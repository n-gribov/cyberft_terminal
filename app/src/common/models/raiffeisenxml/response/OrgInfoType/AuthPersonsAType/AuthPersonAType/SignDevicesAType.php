...
class SignDevicesAType
{
     ...
     *
     * @property \common\models\raiffeisenxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\SignDevicesAType\SignDeviceAType[] $signDevice
     */
    private $signDevice = [
     ...
     */
    public function addToSignDevice(\common\models\raiffeisenxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\SignDevicesAType\SignDeviceAType $signDevice)
    {
