...
/**
 * AdvanceAcceptanceBundle Class Doc Comment
 *
 * @category Class
 ...
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class AdvanceAcceptanceBundle implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'AdvanceAcceptanceBundle';
     ...
     * Sets code
     *
     * @param string $code Код пакета услуг
     *
     * @return $this
     */
     ...
     * Sets sinceDate
     *
     * @param \DateTime $sinceDate Дата подключения пакета услуг
     *
     * @return $this
     */
     ...
     * Sets untilDate
     *
     * @param \DateTime $untilDate Дата отключения пакета услуг
     *
     * @return $this
     */
