...
/**
 * CurrControlMessageToBank Class Doc Comment
 *
 * @category Class
 * @description Письмо для целей ВК (в банк)
 *
 * @author   Swagger Codegen team
 *
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class CurrControlMessageToBank implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'CurrControlMessageToBank';
