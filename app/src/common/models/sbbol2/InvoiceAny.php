 ...
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class InvoiceAny implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'InvoiceAny';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payeeBankCorrAccount'] === null) {
            $invalidProperties[] = "'payeeBankCorrAccount' can't be null";
        }
        if ($this->container['payeeInn'] === null) {
            $invalidProperties[] = "'payeeInn' can't be null";
        }
     ...
     * Sets payeeBankBic
     *
     * @param string $payeeBankBic БИК банка получателя платежа
     *
     * @return $this
     */
     ...
     *
     * @param string $payeeBankCorrAccount Кор. счёт банка получателя платежа
     *
     * @return $this
     */
     ...
     * Sets payeeName
     *
     * @param string $payeeName Наименование получателя платежа
     *
     * @return $this
     */
