...
/**
 * Class ConfDocInquiry138IConfDocNotPS
 * @package common\models\vtbxml\documents
 * @property \common\models\vtbxml\documents\fields\Field $fields
 */
class ConfDocInquiry138IConfDocNotPS extends BSDocument
{
    const TYPE = 'ConfDocInquiry138IConfDocNotPS';
    const TYPE_ID = null;
    const VERSIONS = [7];
    const SIGNED_FIELDS_IDS_BY_VERSION = [
        7 => ['DOCDATE', 'DOCCODE', 'CURRCODE1', 'AMOUNTCURRENCY1', 'CURRCODE2', 'AMOUNTCURRENCY2', 'ADDINFO', 'NUM', 'DOCUMENTNUMBER', 'FDELIVERY', 'EXPECTDATE', 'COUNTRYCODE', 'REMARK', 'AMOUNTCURRENCY11', 'AMOUNTCURRENCY21'],
    ];
