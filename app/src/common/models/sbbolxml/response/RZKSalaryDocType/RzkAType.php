...
class RzkAType
{
     ...
     *
     * @property \common\models\sbbolxml\response\RZKSalaryDocType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType[] $rzkDocanalytics
     */
     ...
     */
    public function addToRzkDocanalytics(\common\models\sbbolxml\response\RZKSalaryDocType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType $rzkDocanalytic)
    {
     ...
     * Многострочная аналитика платежного документа в соответствии со справочниками РЦК (СБК)
     *
     * @param \common\models\sbbolxml\response\RZKSalaryDocType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType[] $rzkDocanalytics
     * @return static
     */
