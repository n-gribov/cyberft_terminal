...
class CreditContractsAType
{
    ...
    /**
     * @property \common\models\sbbolxml\response\AccountRubType\OtherAccountDataAType\CreditContractsAType\CreditContractAType[] $creditContract
     */
     ...
     */
    public function addToCreditContract(\common\models\sbbolxml\response\AccountRubType\OtherAccountDataAType\CreditContractsAType\CreditContractAType $creditContract)
    {
