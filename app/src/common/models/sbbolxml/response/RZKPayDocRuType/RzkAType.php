...
namespace common\models\sbbolxml\response\RZKPayDocRuType;
...
class RzkAType
{
     ...
     *
     * @property \common\models\sbbolxml\response\RZKPayDocRuType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType[] $rzkDocanalytics
     */
     ...
     *
     * @return static
     * @param \common\models\sbbolxml\response\RZKPayDocRuType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType $rzkDocanalytic
     */
    public function addToRzkDocanalytics(\common\models\sbbolxml\response\RZKPayDocRuType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType $rzkDocanalytic)
    {
     ...
     * Многострочная аналитика платежного документа в соответствии со справочниками РЦК (СБК)
     *
     * @return \common\models\sbbolxml\response\RZKPayDocRuType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType[]
     */
     ...
     * Многострочная аналитика платежного документа в соответствии со справочниками РЦК (СБК)
     *
     * @param \common\models\sbbolxml\response\RZKPayDocRuType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType[] $rzkDocanalytics
     * @return static
     */
