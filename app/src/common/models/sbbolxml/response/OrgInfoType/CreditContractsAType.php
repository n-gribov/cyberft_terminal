...
class CreditContractsAType
{
    ...
    /**
     * @property \common\models\sbbolxml\response\OrgInfoType\CreditContractsAType\CreditContractAType[] $creditContract
     */
     ...
     */
    public function addToCreditContract(\common\models\sbbolxml\response\OrgInfoType\CreditContractsAType\CreditContractAType $creditContract)
    {
