...
class SalaryContractsAType
{
     ...
     *
     * @property \common\models\sbbolxml\response\OrgInfoType\SalaryContractsAType\SalaryContractAType[] $salaryContract
     */
     ...
     */
    public function addToSalaryContract(\common\models\sbbolxml\response\OrgInfoType\SalaryContractsAType\SalaryContractAType $salaryContract)
    {
