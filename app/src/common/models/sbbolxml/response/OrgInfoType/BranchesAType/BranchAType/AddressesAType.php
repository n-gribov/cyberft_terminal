...
class AddressesAType
{
     ...
     * Адрес подразделения
     *
     * @property \common\models\sbbolxml\response\OrgInfoType\BranchesAType\BranchAType\AddressesAType\AddressAType[] $address
     */
     ...
     */
    public function addToAddress(\common\models\sbbolxml\response\OrgInfoType\BranchesAType\BranchAType\AddressesAType\AddressAType $address)
    {
