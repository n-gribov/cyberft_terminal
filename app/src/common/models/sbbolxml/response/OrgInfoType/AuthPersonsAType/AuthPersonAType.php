...
namespace common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType;
...
class AuthPersonAType
{
     ...
     *
     * @property \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\AccountsAType\AccountAType[] $accounts
     */
     ...
     *
     * @property \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\SignDevicesAType\SignDeviceAType[] $signDevices
     */
     ...
     * Полномочия подписи
     *
     * @property \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\AuthSignsAType\AuthSignAType[] $authSigns
     */
    private $authSigns = null;

    /**
     * Услуги, предоставляемые уполномоченному лицу. Передаем
     *  подключенные пакеты услуг
     *
     * @property \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\ServicePackagesAType\ServicePackageAType[] $servicePackages
     */
     ...
     */
    public function addToAccounts(\common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\AccountsAType\AccountAType $account)
    {
     ...
     * Перчень счетов, доступных данному уполномоченному лицу
     *
     * @param \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\AccountsAType\AccountAType[] $accounts
     * @return static
     */
     ...
     *
     * @return static
     * @param \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\SignDevicesAType\SignDeviceAType $signDevice
     */
    public function addToSignDevices(\common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\SignDevicesAType\SignDeviceAType $signDevice)
    {
     ...
     * Средства подписи, доступные данному уполномоченному лицу
     *
     * @return \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\SignDevicesAType\SignDeviceAType[]
     */
     ...
     * Средства подписи, доступные данному уполномоченному лицу
     *
     * @param \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\SignDevicesAType\SignDeviceAType[] $signDevices
     * @return static
     */
     ...
     */
    public function addToAuthSigns(\common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\AuthSignsAType\AuthSignAType $authSign)
    {
     ...
     * Полномочия подписи
     *
     * @param \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\AuthSignsAType\AuthSignAType[] $authSigns
     * @return static
     */
     ...
     */
    public function addToServicePackages(\common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\ServicePackagesAType\ServicePackageAType $servicePackage)
    {
     ...
     *  подключенные пакеты услуг
     *
     * @param \common\models\sbbolxml\response\OrgInfoType\AuthPersonsAType\AuthPersonAType\ServicePackagesAType\ServicePackageAType[] $servicePackages
     * @return static
     */
