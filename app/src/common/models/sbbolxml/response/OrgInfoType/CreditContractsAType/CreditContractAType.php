...
namespace common\models\sbbolxml\response\OrgInfoType\CreditContractsAType;
...
class CreditContractAType
{
    ...
    /**
     * Идентификатор контракта на услуги
     *
    ...
    /**
     * @property \common\models\sbbolxml\response\OrgInfoType\CreditContractsAType\CreditContractAType\AvailableAccsAType[] $availableAccs
     */
     ...
     *
     * @return static
     * @param \common\models\sbbolxml\response\OrgInfoType\CreditContractsAType\CreditContractAType\AvailableAccsAType $availableAccs
     */
    public function addToAvailableAccs(\common\models\sbbolxml\response\OrgInfoType\CreditContractsAType\CreditContractAType\AvailableAccsAType $availableAccs)
    {
     ...
     *
     * @return \common\models\sbbolxml\response\OrgInfoType\CreditContractsAType\CreditContractAType\AvailableAccsAType[]
     */
