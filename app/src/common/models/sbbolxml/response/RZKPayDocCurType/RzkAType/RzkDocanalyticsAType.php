...
namespace common\models\sbbolxml\response\RZKPayDocCurType\RzkAType;
...
class RzkDocanalyticsAType
{
     ...
     *
     * @property \common\models\sbbolxml\response\RZKPayDocCurType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType[] $rzkDocanalytic
     */
     ...
     */
    public function addToRzkDocanalytic(\common\models\sbbolxml\response\RZKPayDocCurType\RzkAType\RzkDocanalyticsAType\RzkDocanalyticAType $rzkDocanalytic)
    {
