...
namespace common\models\sbbolxml\response\ContractType\ContractServicesAType\ContractServiceAType\AccountsAType\AccountAType;
...
class PaymentControlAType
{
    ...
    /**
     * Сумма документа, начиная с
     *  которой требовать одну
     *  визирующую подпись
     *
     * @property float $sum1
     */
