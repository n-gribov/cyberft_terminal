...
namespace common\models\sbbolxml\response\ContractType\ContractServicesAType;
...
class ContractServiceAType
{
    ...
    /**
     * Идентификатор подразделения банка, с которым заключен контракт
     *  у Организации
     *
    ...
    /**
     * 0 - Нет, 1 - Да
     *  Признак "На все счета", который обуславливает автоматическое подключение
     *  нового счета организации в рамках услуги
     *
     * @property boolean $allAccounts
     */
     ...
     *
     * @property \common\models\sbbolxml\response\ContractType\ContractServicesAType\ContractServiceAType\AccountsAType\AccountAType[] $accounts
     */
    private $accounts = null;

    /**
     * Услуги, предоставляемые уполномоченному лицу. Передаем
     *  только подключенные пакеты.
     *
     * @property \common\models\sbbolxml\response\ContractType\ContractServicesAType\ContractServiceAType\ServicePacksAType\ServicePackAType[] $servicePacks
     */
     ...
     */
    public function addToAccounts(\common\models\sbbolxml\response\ContractType\ContractServicesAType\ContractServiceAType\AccountsAType\AccountAType $account)
    {
     ...
     * Доступные счета по контракту
     *
     * @param \common\models\sbbolxml\response\ContractType\ContractServicesAType\ContractServiceAType\AccountsAType\AccountAType[] $accounts
     * @return static
     */
     ...
     */
    public function addToServicePacks(\common\models\sbbolxml\response\ContractType\ContractServicesAType\ContractServiceAType\ServicePacksAType\ServicePackAType $servicePack)
    {
     ...
     *  только подключенные пакеты.
     *
     * @param \common\models\sbbolxml\response\ContractType\ContractServicesAType\ContractServiceAType\ServicePacksAType\ServicePackAType[] $servicePacks
     * @return static
     */
