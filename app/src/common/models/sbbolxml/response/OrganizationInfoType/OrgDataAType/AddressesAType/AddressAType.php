...
namespace common\models\sbbolxml\response\OrganizationInfoType\OrgDataAType\AddressesAType;
...
class AddressAType
{
    ...
    /**
     * ISO-код страны (3-х символьный код страны)
     *
