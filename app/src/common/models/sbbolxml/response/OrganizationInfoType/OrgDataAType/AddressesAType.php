...
class AddressesAType
{
    ...
    /**
     * @property \common\models\sbbolxml\response\OrganizationInfoType\OrgDataAType\AddressesAType\AddressAType[] $address
     */
     ...
     */
    public function addToAddress(\common\models\sbbolxml\response\OrganizationInfoType\OrgDataAType\AddressesAType\AddressAType $address)
    {
