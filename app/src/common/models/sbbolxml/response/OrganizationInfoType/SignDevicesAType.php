...
class SignDevicesAType
{
     ...
     *
     * @property \common\models\sbbolxml\response\OrganizationInfoType\SignDevicesAType\SignDeviceAType[] $signDevice
     */
     ...
     */
    public function addToSignDevice(\common\models\sbbolxml\response\OrganizationInfoType\SignDevicesAType\SignDeviceAType $signDevice)
    {
