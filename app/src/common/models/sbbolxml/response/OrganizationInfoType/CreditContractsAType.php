...
class CreditContractsAType
{
    ...
    /**
     * @property \common\models\sbbolxml\response\OrganizationInfoType\CreditContractsAType\CreditContractAType[] $creditContract
     */
     ...
     */
    public function addToCreditContract(\common\models\sbbolxml\response\OrganizationInfoType\CreditContractsAType\CreditContractAType $creditContract)
    {
