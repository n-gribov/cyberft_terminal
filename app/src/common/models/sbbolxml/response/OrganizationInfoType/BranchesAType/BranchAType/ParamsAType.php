...
class ParamsAType
{
     ...
     *
     * @property \common\models\sbbolxml\response\OrganizationInfoType\BranchesAType\BranchAType\ParamsAType\ParamAType[] $param
     */
    private $param = array(
     ...
     */
    public function addToParam(\common\models\sbbolxml\response\OrganizationInfoType\BranchesAType\BranchAType\ParamsAType\ParamAType $param)
    {
        $this->param[] = $param;
        return $this;
    }
