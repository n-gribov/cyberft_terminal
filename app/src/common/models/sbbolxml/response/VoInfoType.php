...
class VoInfoType
{
     ...
     * Контракт
     *
     * @property \common\models\sbbolxml\response\VoInfoType\ContractAType $contract
     */
     ...
     * Контракт
     *
     * @return \common\models\sbbolxml\response\VoInfoType\ContractAType
     */
     ...
     * Контракт
     *
     * @param \common\models\sbbolxml\response\VoInfoType\ContractAType $contract
     * @return static
     */
    public function setContract(\common\models\sbbolxml\response\VoInfoType\ContractAType $contract)
    {
