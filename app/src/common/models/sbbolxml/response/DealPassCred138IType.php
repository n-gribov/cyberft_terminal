...
class DealPassCred138IType
{
    ...
    /**
     * Идентификатор паспорта сделки по кредитному договору в СББОЛ (UUID документа)
     *
     ...
     *
     * @property \common\models\sbbolxml\response\ComDataCredType $comDataCred
     */
     ...
     *
     * @property \common\models\sbbolxml\response\HelpInfoType $helpInfo
     */
     ...
     * Общие сведения о кредитном договоре
     *
     * @return \common\models\sbbolxml\response\ComDataCredType
     */
     ...
     * Общие сведения о кредитном договоре
     *
     * @param \common\models\sbbolxml\response\ComDataCredType $comDataCred
     * @return static
     */
    public function setComDataCred(\common\models\sbbolxml\response\ComDataCredType $comDataCred)
    {
     ...
     * Справочная информация о кредитном договоре
     *
     * @return \common\models\sbbolxml\response\HelpInfoType
     */
     ...
     * Справочная информация о кредитном договоре
     *
     * @param \common\models\sbbolxml\response\HelpInfoType $helpInfo
     * @return static
     */
    public function setHelpInfo(\common\models\sbbolxml\response\HelpInfoType $helpInfo)
    {
