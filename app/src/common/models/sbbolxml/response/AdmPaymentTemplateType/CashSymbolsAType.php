...
class CashSymbolsAType
{
    ...
    /**
     * @property \common\models\sbbolxml\response\AdmPaymentTemplateType\CashSymbolsAType\CashSymbolAType[] $cashSymbol
     */
     ...
     */
    public function addToCashSymbol(\common\models\sbbolxml\response\AdmPaymentTemplateType\CashSymbolsAType\CashSymbolAType $cashSymbol)
    {
