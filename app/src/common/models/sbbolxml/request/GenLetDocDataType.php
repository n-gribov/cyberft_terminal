...
class GenLetDocDataType
{
     ...
     *
     * @property \common\models\sbbolxml\request\GenLetOrgDataType $orgData
     */
     ...
     * Основные реквизиты организации, указываемые в документе
     *
     * @return \common\models\sbbolxml\request\GenLetOrgDataType
     */
     ...
     * Основные реквизиты организации, указываемые в документе
     *
     * @param \common\models\sbbolxml\request\GenLetOrgDataType $orgData
     * @return static
     */
    public function setOrgData(\common\models\sbbolxml\request\GenLetOrgDataType $orgData)
    {
