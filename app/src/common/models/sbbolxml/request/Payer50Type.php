...
class Payer50Type
{
     ...
     *  Customer Account
     *
     * @property \common\models\sbbolxml\request\AccNumBicType $accDoc
     */
    private $accDoc = null;
     ...
     *  Customer Account
     *
     * @param \common\models\sbbolxml\request\AccNumBicType $accDoc
     * @return static
     */
    public function setAccDoc(\common\models\sbbolxml\request\AccNumBicType $accDoc)
    {
        $this->accDoc = $accDoc;
        return $this;
    }
