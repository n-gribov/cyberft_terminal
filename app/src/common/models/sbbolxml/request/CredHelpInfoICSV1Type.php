...
/**
 * Class representing CredHelpInfoICSV1Type
 *
 * Справочная информация о кредитном договоре
 * XSD Type: CredHelpInfoICSV1
 */
class CredHelpInfoICSV1Type
{
     ...
     *
     * @property \common\models\sbbolxml\request\CredHelpInfoICSV1Type\BailSumAType $bailSum
     */
     ...
     *
     * @property \common\models\sbbolxml\request\CreditInfoICSV1Type[] $creditInfos
     */
     ...
     * Сумма залогового или другого обеспечения
     *
     * @return \common\models\sbbolxml\request\CredHelpInfoICSV1Type\BailSumAType
     */
     ...
     * Сумма залогового или другого обеспечения
     *
     * @param \common\models\sbbolxml\request\CredHelpInfoICSV1Type\BailSumAType $bailSum
     * @return static
     */
    public function setBailSum(\common\models\sbbolxml\request\CredHelpInfoICSV1Type\BailSumAType $bailSum)
    {
     ...
     *
     * @return static
     * @param \common\models\sbbolxml\request\CreditInfoICSV1Type $creditInfo
     */
    public function addToCreditInfos(\common\models\sbbolxml\request\CreditInfoICSV1Type $creditInfo)
    {
     ...
     * Информация о привлечении резидентом кредита (займа) на синдицированной (консорциональной) основе
     *
     * @return \common\models\sbbolxml\request\CreditInfoICSV1Type[]
     */
     ...
     * Информация о привлечении резидентом кредита (займа) на синдицированной (консорциональной) основе
     *
     * @param \common\models\sbbolxml\request\CreditInfoICSV1Type[] $creditInfos
     * @return static
     */
