...
class PayeeInfoAType
{
     ...
     * Реквизиты счета
     *
     * @property \common\models\sbbolxml\request\AdmPaymentTemplateType\PayeeInfoAType\AccountAType $account
     */
     ...
     * Реквизиты счета
     *
     * @return \common\models\sbbolxml\request\AdmPaymentTemplateType\PayeeInfoAType\AccountAType
     */
     ...
     * Реквизиты счета
     *
     * @param \common\models\sbbolxml\request\AdmPaymentTemplateType\PayeeInfoAType\AccountAType $account
     * @return static
     */
    public function setAccount(\common\models\sbbolxml\request\AdmPaymentTemplateType\PayeeInfoAType\AccountAType $account)
    {
