...
/**
 * Class representing CredDebtPaymentLoanICSType
 *
 * Описание платежа по возврату основного долга и процентов
 * XSD Type: CredDebtPaymentLoanICS
 */
class CredDebtPaymentLoanICSType
{
