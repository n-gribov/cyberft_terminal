...
namespace common\models\sbbolxml\request\PayRequestType;
...
class PayReqInfoAType
{
    ...
    /**
     * Дата отсылки документа
     *
     * @property \DateTime $docSend
     */
    private $docSend = null;
     ...
     *  реквизита "Сумма"
     *
     * @property integer $balancePayDoc
     */
     ...
     * Дата отсылки документа
     *
     * @param \DateTime $docSend
     * @return static
     */
    public function setDocSend(\DateTime $docSend)
    {
