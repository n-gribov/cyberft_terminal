...
class ADMTemplatesAType
{
     ...
     *
     * @property \common\models\sbbolxml\request\AdmCashierType\ADMTemplatesAType\TemplateAType[] $template
     */
     ...
     */
    public function addToTemplate(\common\models\sbbolxml\request\AdmCashierType\ADMTemplatesAType\TemplateAType $template)
    {
