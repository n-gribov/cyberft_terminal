...
class SalaryContractAType
{
     ...
     *
     * @property string $filialName
     */
    private $filialName = null;

    /**
     * Наименование подразделения банка ("держатель
     *  контракта")
     *
    ...
    /**
     * Номер филиала, указанный в справочнике з.договоров
     *  СББОЛ
     *
