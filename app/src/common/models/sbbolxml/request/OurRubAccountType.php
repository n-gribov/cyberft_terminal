...
/**
 * Class representing OurRubAccountType
 *
 *
 * XSD Type: OurRubAccountType
 */
class OurRubAccountType extends AccountRubType
{

    /**
     * 0 - Средства в рублях перечислить на наш счет в Сбербанке России
     *  1 - Средства в рублях перечислить на счет в другом банке / в других филиалах и отделениях
     *  Сбербанка России
     *
