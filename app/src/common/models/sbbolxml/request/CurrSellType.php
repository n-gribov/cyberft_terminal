 ...
 * XSD Type: CurrSell
 */
class CurrSellType extends DocBaseType
{
     ...
     * Сделка
     *
     * @property \common\models\sbbolxml\request\CurrSellTransType $trans
     */
    private $trans = null;
     ...
     * Сделка
     *
     * @return \common\models\sbbolxml\request\CurrSellTransType
     */
     ...
     * Сделка
     *
     * @param \common\models\sbbolxml\request\CurrSellTransType $trans
     * @return static
     */
    public function setTrans(\common\models\sbbolxml\request\CurrSellTransType $trans)
    {
        $this->trans = $trans;
        return $this;
    }
