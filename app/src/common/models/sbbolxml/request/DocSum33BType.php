...
class DocSum33BType
{
     ...
     *
     * @property \common\models\sbbolxml\request\CurrAmountType $docSumTransfer
     */
     ...
     * Сумма и валюта перевода
     *
     * @param \common\models\sbbolxml\request\CurrAmountType $docSumTransfer
     * @return static
     */
    public function setDocSumTransfer(\common\models\sbbolxml\request\CurrAmountType $docSumTransfer)
    {
