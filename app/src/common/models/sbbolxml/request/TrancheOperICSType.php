...
/**
 * Class representing TrancheOperICSType
 *
 * Сведения о сумме и сроках привлечения (предоставления) транша
 * XSD Type: TrancheOperICS
 */
class TrancheOperICSType
{

    /**
     * Сумма транша
     *
     * @property \common\models\sbbolxml\request\CurrAmountTypeV1Type $sum
     */
    private $sum = null;
     ...
     * Сумма транша
     *
     * @param \common\models\sbbolxml\request\CurrAmountTypeV1Type $sum
     * @return static
     */
    public function setSum(\common\models\sbbolxml\request\CurrAmountTypeV1Type $sum)
    {
        $this->sum = $sum;
        return $this;
    }
