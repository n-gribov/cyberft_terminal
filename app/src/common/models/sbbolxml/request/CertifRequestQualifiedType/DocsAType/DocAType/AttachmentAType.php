...
namespace common\models\sbbolxml\request\CertifRequestQualifiedType\DocsAType\DocAType;
...
class AttachmentAType
{
    ...
    /**
     * Пользовательское описание файла
     *  вложения
     *
    ...
    /**
     * В бинарном представлении в сжатом и
     *  несжатом виде
     *
