...
use common\helpers\raiffeisen\RaiffeisenXmlSerializer\XmlDeserializationVisitor;
...
class RaiffeisenXmlSerializer
{
    const METADATA_DIRS = [
        'common\models\raiffeisenxml\request'  => '@common/models/raiffeisenxml/request/_metadata',
        'common\models\raiffeisenxml\response' => '@common/models/raiffeisenxml/response/_metadata',
    ];
