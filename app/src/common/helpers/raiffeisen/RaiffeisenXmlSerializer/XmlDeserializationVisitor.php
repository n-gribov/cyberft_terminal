...
namespace common\helpers\raiffeisen\RaiffeisenXmlSerializer;
 ...
 * @package common\helpers\raiffeisen\RaiffeisenXmlSerializer
 * Код скопирован из app/src/vendor/jms/serializer/src/JMS/Serializer/XmlDeserializationVisitor.php.
 * Этот класс отличается от оригинального XmlDeserializationVisitor тем, что интерпретирует пустую строку
 * как false у атрибутов с типом boolean.
 * С помощью наследования этого достичь не удалось из-за наличия приватных полей.
 */
