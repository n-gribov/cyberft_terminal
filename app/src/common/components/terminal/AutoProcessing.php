...
class AutoProcessing extends RedisModel
{
	...
	{
		return [
//			'fixSender' => Yii::t('app', 'Automatically fix document sender'),
//			'swiftIsRoute' => Yii::t('app', 'Activate swift documents routing'),
//			'swiftRoutePath' => Yii::t('app', 'Path for route swift documents'),
