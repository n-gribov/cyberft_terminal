...
/**
 * Контроллер содержит консольные команды для аддона ISO20022
 */
class DefaultController extends ConsoleController
{
    ...
    /** Метод выполняет тестовое подписание
    ...
    /**
     * Метод выполняет тестовую верификацию
    ...
    /**
     * Метод выполняет реэкспорт документов
     * @param type $id1 с какого id включительно
     * @param type $id2 по какой id включительно
     */
    ...
    /**
     * Метод отправляет Status Report, если они не были отправлены
     * @param type $id1
     * @param type $id2
     * @param type $override
     */
