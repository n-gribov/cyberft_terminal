					...
					'scheme' => [
						...
						[
							...
							'scheme'    => [
								...
								[
									'label' => 'Признак',
									//									'strict' => ['AFTE', 'BEFO', 'INFO', 'WITH'] // см. доку
								],
							],
						],
						[
		...
		[
			...
			'scheme' => [
				...
				[
					'status'    => Entity::STATUS_OPTIONAL,
					'name'      => '99A',
					'label'     => 'Количество дней, за которые начисляются проценты',
								...
								[
									...
									'scheme'    => [
										[
											'label'  => 'Определитель',
											'strict' => [
												'PRFC', 'CUFC', 'NWFC', 'INTR', 'NXRT', 'INDX', 'YTMR'
											]
										],
										[
											'label' => 'Знак',
...
// см. доку
//									'strict' => [
//										'CLOP', 'OPEP', 'DEFR', 'EXCH', 'TRRE', 'LAMI', 'NBOR', 'YBOR', 'BCBL',
