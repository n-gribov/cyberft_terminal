package CyberFT::SWIFT::Types::MT540;
...
our $ValidationProfile = {
    ...
    rules => [
        ...
        # С12
        # Если поле :36B: присутствует хотя бы в одном повторении подпоследовательности А1, то
        # тип расчетной операции должен определяться как взаимозачет или оборот8, т.е. в
        # последовательности E должно присутствовать поле :22F::SETR//PAIR (Код ошибки С50).
        {
            func => sub {
                my $doc = shift;
                my $tree = build_seq_tree($doc->data);
