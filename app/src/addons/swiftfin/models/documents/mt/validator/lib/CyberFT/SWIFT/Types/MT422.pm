package CyberFT::SWIFT::Types::MT422;
...
#        },
    ...
    rules => [
        ...
        #C2 В сообщении должно присутствовать хотя бы одно из полей однократной последовательности (поле 72, 75 или 76)
        # (Код ошибки С10)
        {
            func => sub {
                my $doc = shift;
                if( !$doc->key_exists('72') && !$doc->key_exists('75') && !$doc->key_exists('76') ) {
                    return 0;
                }
                return 1;
            },
        ...
        # C2
        # Код валюты в полях сумм 32а должен быть одинаковым во всех повторениях этого поля в сообщении(Код ошибки С02).
        {
            func => sub {
                my $doc = shift;
