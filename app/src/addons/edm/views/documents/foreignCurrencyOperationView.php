...
<?php
    // Вывести блок с транспортной информацией
    echo $this->render('_fcoTransportInfo', compact('document', 'businessStatus', 'businessStatusDescription'));
    // Вывести страницу
    echo $this->render('readable/foreignCurrencyOperation', ['document' => $document, 'typeModel' => $typeModel]);
?>
<br/><br/>
<?php
