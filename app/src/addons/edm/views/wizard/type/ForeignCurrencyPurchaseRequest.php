...
/* @var $model addons\edm\models\ForeignCurrencyPurchaseRequest */
...
<table class="table">
	<tr>
		...
		<td>
			...
			<?php \yii\jui\DatePicker::widget([
				'id'         => 'edmforeigncurrencypurchaserequest-date',
				'dateFormat' => 'dd.MM.yyyy',
			]) ?>
			<?php \yii\widgets\MaskedInput::widget([
				'id'            => 'edmforeigncurrencypurchaserequest-date',
				'name'          => 'edmforeigncurrencypurchaserequest-date',
				'mask'          => '99.99.9999',
				'clientOptions' => [
	...
	<tr>
		...
		<td>
			...
			<?php \yii\widgets\MaskedInput::widget([
				'id'            => 'edmforeigncurrencypurchaserequest-implementerphone',
				'name'          => 'edmforeigncurrencypurchaserequest-implementerphone',
...
<?php \yii\widgets\MaskedInput::widget([
	'id'            => 'edmforeigncurrencypurchaserequest-accountcurrency',
	'name'          => 'edmforeigncurrencypurchaserequest-accountcurrency',
...
<script language="JavaScript" type="text/javascript">
	...
	$(window).ready(function () {
		$('#edmforeigncurrencypurchaserequest-fromname').attr('readonly', true);
		$('#edmforeigncurrencypurchaserequest-accountrub').change(function(){
			var attr = recipient[$(this).val()];
			if (attr !== undefined) {
				$('#edmforeigncurrencypurchaserequest-accountclient').val($(this).val());
				$('#edmforeigncurrencypurchaserequest-fromname').val(attr.name);
			} else {
				$('#edmforeigncurrencypurchaserequest-accountclient').val('');
				$('#edmforeigncurrencypurchaserequest-fromname').val('');
			}
		});
	});
