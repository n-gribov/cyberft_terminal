...
/**
 * This is the model class for table "edm_scheduledRequestPrevious".
 *
 ...
 */
class EdmScheduledRequestPrevious extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
	
    public $previousDaysSelect;
	
    public static function tableName()
    {
        return 'edm_scheduledRequestPrevious';
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'previousDaysSelect' => Yii::t('app', 'Days of week'),
        ];
    }
