...
//			$this->log('================================');
//			$this->log('=== MODE: '.$this->args['date']);
//			$this->log('=== ACCOUNT NUMBER: '.$record->accountNumber);
//			$this->log('=== CURRENT TIME: '.date('H:i:s'));
//			$this->log('=== LAST TIME: '.$record->lastTime);
			
			if ( $record->currentDay != date('Y-m-d') ) {
//				$this->log('=== CURRENT DAY IS DIFFERENT');
				$record->currentDay = date('Y-m-d');
//				$this->log('=== CURRENT DAY: '.date('Y-m-d'));
	...
	{
//		$this->log('=== REQUEST STATEMENT');
//		$this->log($this->args['date']);
...
//			$this->log('=== ORGANIZATION ID: '.$account->organizationId);
