...
<div class="row" style="margin-top: 15px;">
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-2">
                <?=Html::a(Yii::t('app/fileact', 'Add certificate'), ['/cryptopro-certs-fileact/create'], ['class' => 'btn btn-primary']);?>
            </div>
        </div>
                    ...
                    'value' => function ($item, $params) {
                        if (!empty($item->certData)) {
                            return Html::a('<i class="glyphicon glyphicon-eye-open">
                                        </i> ', Url::toRoute(['/cryptopro-certs-fileact/view', 'id' => $item->id]));
                        }
                    ...
                    'value' => function ($item, $params) {
                        ...
                        if ($item->status == CryptoproCert::STATUS_READY) {
                            ...
                            return Html::a('<span class="glyphicon glyphicon-cog"></span>',
                                Url::toRoute(['/cryptopro-certs-fileact/update', 'id' => $item->id]));
                        }
                        ...
                        'delete' => function ($url, $model) {
                            ...
                            if ($model->status == CryptoproCert::STATUS_READY) {
                                ...
                                return Html::a('<span class="glyphicon glyphicon-trash"></span>',
                                    Url::toRoute(['/cryptopro-certs-fileact/delete', 'id' => $model->id]), [
