...
class FileActHelper
{
    ...
    public static function generatePDU($uuid, $sender, $receiver, $binFileName)
    {
        ...
        $xml->Header->Message->Sender->DN = 'o=' . TerminalId::extractBIC8($sender) . ',o=' . $organization;
        $xml->Header->Message->Sender->FullName->X1 = $sender;
        $xml->Header->Message->Receiver->DN = 'o=' . TerminalId::extractBIC8($receiver) . ',o=' . $organization;
