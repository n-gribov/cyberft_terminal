...
folder="$APP_DIR/src/addons/SBBOL"
echo "Remove $folder"
rm -rf "$folder"

folder="$APP_DIR/src/addons/sbbol2"
echo "Remove $folder"
rm -rf "$folder"

folder="$APP_DIR/src/addons/VTB"
echo "Remove $folder"
rm -rf "$folder"
...
distrName=cyberft_raiffeisen-$tagId.tar.gz
shopt -s dotglob
tar -czf "/home/_builds/raiffeisen/$distrName" *
shopt -u dotglob
echo "archive created to /home/_builds/raiffeisen/$distrName"